...
function init_webrtc(media_stream, offer_uri, output_element) {
...
function negotiate(offer_uri, pc) {
    signalingSocket = new WebSocket( offer_uri );

    return pc.createOffer()
            .then( function(offer) { return pc.setLocalDescription(offer); } )
            .then( function() { waitForIceStatePromise(pc); } )
            .then( function() { sendOfferPromise(offer_uri, pc.localDescription); } )
